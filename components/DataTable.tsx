...
const DataTable = <T extends Record<string, any>>({ columns, data, rowKey, tableClassName, headerRowClassName,
    headerCellClassName, headerClassName, bodyRowClassName, bodyCellClassName
    }: DataTableProps<T>) => {
  return (
